...
public class AgenteAnchura extends Agent {
	...
	class ComportamientoAgenteAnchura extends Behaviour {
		...
		public void action() {
			...
			// Enviamos la lista que retorna la clase anchura al constructor de la clase
			// serializada: DatosSeriales
			// Invocando al metodo iniciarBusqueda, obtenemos la lista recorrida por
			// anchura:
			s = new DatosSeriales(new Anchura(ar.nodosDelArbol, ar.generarMatrizIdeal()).iniciarBusqueda(),
					" recorrió en anchura: ");
